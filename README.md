...
``` bash
GO111MODULE="on" go get github.com/khos2ow/ratelimiter@0.3.2
```
...
```bash
curl -Lo ./ratelimiter https://github.com/khos2ow/ratelimiter/releases/download/0.3.2/ratelimiter-0.3.2-$(uname | tr '[:upper:]' '[:lower:]')-amd64
chmod +x ./ratelimiter
