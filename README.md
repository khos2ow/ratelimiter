...
``` bash
GO111MODULE="on" go get github.com/khos2ow/ratelimiter@v0.2.1
```
...
```bash
curl -Lo ./ratelimiter https://github.com/khos2ow/ratelimiter/releases/download/v0.2.1/ratelimiter-v0.2.1-$(uname | tr '[:upper:]' '[:lower:]')-amd64
chmod +x ./ratelimiter
...
khos2ow/ratelimiter:0.2.1 # <git-tag-without-leading-v>
```
...
// hit #4         allowed: true      elapsed: 0.2.1883 seconds
