...
``` bash
GO111MODULE="on" go get github.com/khos2ow/ratelimiter@0.3.3
```
...
```bash
curl -Lo ./ratelimiter https://github.com/khos2ow/ratelimiter/releases/download/0.3.3/ratelimiter-0.3.3-$(uname | tr '[:upper:]' '[:lower:]')-amd64
chmod +x ./ratelimiter
